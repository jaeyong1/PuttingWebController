...
<html lang="ko">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="bootstrap/onepage_template/css/bootstrap.min.css">
    <link rel="stylesheet" href="bootstrap/onepage_template/css/line-icons.css">
    <link rel="stylesheet" href="bootstrap/onepage_template/css/owl.carousel.css">
    <link rel="stylesheet" href="bootstrap/onepage_template/css/owl.theme.css">
    <link rel="stylesheet" href="bootstrap/onepage_template/css/animate.css">
    <link rel="stylesheet" href="bootstrap/onepage_template/css/magnific-popup.css">
    <link rel="stylesheet" href="bootstrap/onepage_template/css/nivo-lightbox.css">
    <link rel="stylesheet" href="bootstrap/onepage_template/css/main.css">    
    <link rel="stylesheet" href="bootstrap/onepage_template/css/responsive.css">
  ...
  <body>
    ...
    <header id="home" class="hero-area-2">    
      ...
      <nav class="navbar navbar-expand-md bg-inverse fixed-top scrolling-navbar">
        <div class="container">
          <a href="index.html" class="navbar-brand"><img src="bootstrap/onepage_template/img/logo.png" alt=""></a>  
      ...
      <div class="container">      
        <div class="row space-100">
          ...
          <div class="col-lg-5 col-md-12 col-xs-12">
            <div class="intro-img">
              <img src="bootstrap/onepage_template/img/intro-mobile.png" alt="">
            </div>            
          </div>
        </div> 
      </div>             
    ...
    <div id="app-features" class="section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-12 col-xs-12">
            <div class="show-box">
              <img src="bootstrap/onepage_template/img/features/app.png" alt="">
            </div>
          </div>
          <div class="col-lg-4 col-md-12 col-xs-12">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-12 col-sm-12">
            <div class="img-thumb wow fadeInLeft" data-wow-delay="0.3s">
              <img class="img-fluid" src="bootstrap/onepage_template/img/features/img1.png" alt="">
            </div>
          </div>
          <div class="col-lg-6 col-md-12 col-sm-12">
          ...
          <div class="col-lg-6 col-md-12 col-sm-12">
           ...
           <div class="col-lg-6 col-md-12 col-sm-12">
            <div class="img-thumb wow fadeInLeft" data-wow-delay="1.2s">
              <img class="img-fluid" src="bootstrap/onepage_template/img/features/img2.png" alt="">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="touch-slider owl-carousel">
            <div class="item">
              <div class="screenshot-thumb">
                <img class="img-fluid" src="bootstrap/onepage_template/img/screenshot/img-1.png" alt="">
              </div>
            </div>
            <div class="item">
              <div class="screenshot-thumb">
                <img class="img-fluid" src="bootstrap/onepage_template/img/screenshot/img-2.png" alt="">
              </div>
            </div>
            <div class="item">
              <div class="screenshot-thumb">
                <img class="img-fluid" src="bootstrap/onepage_template/img/screenshot/img-3.png" alt="">
              </div>
            </div>
            <div class="item">
              <div class="screenshot-thumb">
                <img class="img-fluid" src="bootstrap/onepage_template/img/screenshot/img-4.png" alt="">
              </div>
            </div>
            <div class="item">
              <div class="screenshot-thumb">
                <img class="img-fluid" src="bootstrap/onepage_template/img/screenshot/img-5.png" alt="">
              </div>
            </div>
            <div class="item">
              <div class="screenshot-thumb">
                <img class="img-fluid" src="bootstrap/onepage_template/img/screenshot/img-6.png" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team wow fadeInUp" data-wow-delay="0.2s">
              <div class="team-thumb">
                <img src="bootstrap/onepage_template/img/team/team1.jpg" alt="">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team wow fadeInUp" data-wow-delay="0.3s">
              <div class="team-thumb">
                <img src="bootstrap/onepage_template/img/team/team2.jpg" alt="">
                <ul class="social-list">
                  <li class="facebook"><a href="#"><i class="lni-facebook-filled"></i></a></li>
                  <li class="twitter"><a href="#"><i class="lni-twitter-filled"></i></a></li>
                  <li class="google-plus"><a href="#"><i class="lni-google-plus"></i></a></li>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team wow fadeInUp" data-wow-delay="0.4s">
              <div class="team-thumb">
                <img src="bootstrap/onepage_template/img/team/team3.jpg" alt="">
                <ul class="social-list">
                  <li class="facebook"><a href="#"><i class="lni-facebook-filled"></i></a></li>
                  <li class="twitter"><a href="#"><i class="lni-twitter-filled"></i></a></li>
                  <li class="google-plus"><a href="#"><i class="lni-google-plus"></i></a></li>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team wow fadeInUp" data-wow-delay="0.5s">
              <div class="team-thumb">
                <img src="bootstrap/onepage_template/img/team/team4.jpg" alt="">
                <ul class="social-list">
                  <li class="facebook"><a href="#"><i class="lni-facebook-filled"></i></a></li>
                  <li class="twitter"><a href="#"><i class="lni-twitter-filled"></i></a></li>
                  <li class="google-plus"><a href="#"><i class="lni-google-plus"></i></a></li>
            ...
            <div id="testimonials" class="touch-slider owl-carousel">
              <div class="item">
                <div class="testimonial-item">
                  <div class="author">
                    <div class="img-thumb">
                      <img src="bootstrap/onepage_template/img/testimonial/img1.png" alt="">
                    </div>
                  </div>
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="author">
                    <div class="img-thumb">
                    <img src="bootstrap/onepage_template/img/testimonial/img2.png" alt="">
                    </div>
                  </div>
                  <div class="content-inner">
                    <p class="description">Appropriately implement one-to-one catalysts for change vis-a-vis wireless catalysts for change. Enthusiastically architect adaptive. Appropriately implement one-to-one catalysts for change vis-a-vis wireless catalysts for change. Enthu.</p>
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="author">
                    <div class="img-thumb">
                    <img src="bootstrap/onepage_template/img/testimonial/img3.png" alt="">
                    </div>
                  </div>
                  <div class="content-inner">
                    <p class="description">Appropriately implement one-to-one catalysts for change vis-a-vis wireless catalysts for change. Enthusiastically architect adaptive. Appropriately implement one-to-one catalysts for change vis-a-vis wireless catalysts for change. Enthu.</p>
      ...
      <div class="container">
        ...
        <div class="row" id="clients-scroller">
          <div class="client-item-wrapper">
            <img src="bootstrap/onepage_template/img/clients/img1.png" alt="">
          </div>
          <div class="client-item-wrapper">
            <img src="bootstrap/onepage_template/img/clients/img2.png" alt="">
          </div>
          <div class="client-item-wrapper">
            <img src="bootstrap/onepage_template/img/clients/img3.png" alt="">
          </div>
          <div class="client-item-wrapper">
            <img src="bootstrap/onepage_template/img/clients/img4.png" alt="">
          </div>
          <div class="client-item-wrapper">
            <img src="bootstrap/onepage_template/img/clients/img5.png" alt="">
          </div>
        </div>
      </div>
    </div>
	...
	<section id="download">
		<div class="container">
			<div class="section-header">
				<p class="btn btn-subtitle wow fadeInDown" data-wow-delay="0.2s">Download</p>
				<h2 class="section-title">Program Download & Install</h2>
			</div>
			<div class="row">
				<div class="col-lg-6 col-md-6 col-xs-12">
					<div class="download-thumb wow fadeInLeft" data-wow-delay="0.2s">
						<img class="img-fluid"
							src="bootstrap/onepage_template/img/programdownload.jpg" alt="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-xs-12">
					<div class="download-wrapper wow fadeInRight" data-wow-delay="0.2s">
						<div>
							<div class="download-text">
								<h4>Shop Manager 다운로드</h4>
								<p>
									인터넷에서 .Net Frameowork 4.5.2를 다운받아 설치 후, Shop Manager 프로그램을 압축을
									풀면 실행 할 수 있습니다. <br>Windows 7, Windows 10에서 동작확인 되었으며, 설치를
									위한 별도의 Installer는 필요하지 않습니다.
								</p>
							</div>
							<a
								href="https://www.microsoft.com/net/download/dotnet-framework-runtime/net452"
								class="btn btn-common btn-effect">1. .Net Framework 4.5.2
								다운로드<br>
							</a><br> <a href="file/Shopmanager_v0.51.zip"
								class="btn btn-apple">2. Shop Manager 다운로드<br></a>
						</div>
					</div>
				</div>
			</div>			
	...
	<section id="RemoteControl">
		<div class="container">
			<div class="section-header">
				<p class="btn btn-subtitle wow fadeInDown" data-wow-delay="0.2s">원격접속
					지원요청</p>
				<h2 class="section-title">Support Remote PC Control</h2>
			</div>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-xs-12">
					<div class="download-wrapper wow fadeInRight" data-wow-delay="0.2s">
						<div>
							<div class="download-text">
								<h4>원격지원 요청하기</h4>
								<p>팀뷰(TeamView)는 전세계적으로 인정받은 원격접속 솔루션 입니다. 무료버젼을 실행하고 다음 그림과
									같이 화면에 표시되는 원격접속용 ID와 비밀번호를 알려주세요.엔지니어가 인터넷을 통해 PC의 문제점을 확인하고
									도움을 줄 수 있습니다.</p>
							</div>
							<a
								href="https://download.teamviewer.com/download/TeamViewerQS.exe"
								class="btn btn-common btn-effect">팀뷰 다운로드 & 실행<br></a>
				...
				<div class="col-lg-6 col-md-6 col-xs-12">
					<div class="download-thumb wow fadeInLeft" data-wow-delay="0.2s">
						<img class="img-fluid"
							src="bootstrap/onepage_template/img/teamviewmyscreenshot.jpg"
							alt="">
					</div>
				</div>
			</div>
        ...
        <div class="row">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="bootstrap/onepage_template/img/blog/img1.jpg" alt="">
                </a>   
                <div class="author-img">
                  <img src="bootstrap/onepage_template/img/blog/author.png" alt="">
                </div>             
              </div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="bootstrap/onepage_template/img/blog/img2.jpg" alt="">
                </a>   
                <div class="author-img">
                  <img src="bootstrap/onepage_template/img/blog/author.png" alt="">
                </div>             
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="bootstrap/onepage_template/img/blog/img3.jpg" alt="">
                </a>   
                <div class="author-img">
                  <img src="bootstrap/onepage_template/img/blog/author.png" alt="">
                </div>             
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
              <img src="bootstrap/onepage_template/img/logo.png" alt="">
    ...
    <script src="bootstrap/onepage_template/js/jquery-min.js"></script>
    <script src="bootstrap/onepage_template/js/popper.min.js"></script>
    <script src="bootstrap/onepage_template/js/bootstrap.min.js"></script>
    <script src="bootstrap/onepage_template/js/owl.carousel.js"></script> 
    <script src="bootstrap/onepage_template/js/jquery.mixitup.js"></script>       
    <script src="bootstrap/onepage_template/js/jquery.nav.js"></script>    
    <script src="bootstrap/onepage_template/js/scrolling-nav.js"></script>    
    <script src="bootstrap/onepage_template/js/jquery.easing.min.js"></script>     
    <script src="bootstrap/onepage_template/js/wow.js"></script>   
    <script src="bootstrap/onepage_template/js/jquery.counterup.min.js"></script>     
    <script src="bootstrap/onepage_template/js/nivo-lightbox.js"></script>     
    <script src="bootstrap/onepage_template/js/jquery.magnific-popup.min.js"></script>     
    <script src="bootstrap/onepage_template/js/waypoints.min.js"></script>      
    <script src="bootstrap/onepage_template/js/form-validator.min.js"></script>
    <script src="bootstrap/onepage_template/js/contact-form-script.js"></script>   
    <script src="bootstrap/onepage_template/js/main.js"></script>
